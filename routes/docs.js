...
router.post("/delete/doc", cleanCache, extractJWT, isUserVerified, deleteDocument);
router.post("/update/visibility/doc", cleanCache, extractJWT, isUserVerified, updateVisibility);
router.post("/create/collab", cleanCache, extractJWT, isUserVerified, createCollab);
router.post("/delete/collab", cleanCache, extractJWT, isUserVerified, deleteCollab);
router.get("/get/comments", getComments);
router.get("/get/code", getCode);
router.post("/create/comment", cleanCache, extractJWT, isUserVerified, createComment)
